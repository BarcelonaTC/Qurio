...
@Database(
    entities = [TriviaGameSessionEntity::class, UserStreakEntity::class,  UserStatsEntity::class,
        CharacterGameEntity::class, AchievementEntity::class, VolumeEntity::class],
    version = 1
)
